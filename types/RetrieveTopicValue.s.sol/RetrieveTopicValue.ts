...
export interface RetrieveTopicValueInterface extends Interface {
...
export interface RetrieveTopicValue extends BaseContract {
  connect(runner?: ContractRunner | null): RetrieveTopicValue;
  waitForDeployment(): Promise<this>;

  interface: RetrieveTopicValueInterface;
