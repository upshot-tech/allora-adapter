...
export interface AddFeedScriptInterface extends Interface {
...
export interface AddFeedScript extends BaseContract {
  connect(runner?: ContractRunner | null): AddFeedScript;
  waitForDeployment(): Promise<this>;

  interface: AddFeedScriptInterface;
