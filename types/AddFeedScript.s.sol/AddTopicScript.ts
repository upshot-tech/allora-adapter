...
export interface AddTopicScriptInterface extends Interface {
...
export interface AddTopicScript extends BaseContract {
  connect(runner?: ContractRunner | null): AddTopicScript;
  waitForDeployment(): Promise<this>;

  interface: AddTopicScriptInterface;
