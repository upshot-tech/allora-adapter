...
export interface AlloraAdapterTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "IS_TEST"
      | "excludeArtifacts"
...
export interface AlloraAdapterTest extends BaseContract {
  connect(runner?: ContractRunner | null): AlloraAdapterTest;
  waitForDeployment(): Promise<this>;

  interface: AlloraAdapterTestInterface;
