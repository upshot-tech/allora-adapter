...
export interface VerifyDataExampleInterface extends Interface {
...
export interface VerifyDataExample extends BaseContract {
  connect(runner?: ContractRunner | null): VerifyDataExample;
  waitForDeployment(): Promise<this>;

  interface: VerifyDataExampleInterface;
