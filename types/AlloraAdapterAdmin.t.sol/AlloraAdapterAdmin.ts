...
export interface AlloraAdapterAdminInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "IS_TEST"
      | "evenFeeHandler"
...
export interface AlloraAdapterAdmin extends BaseContract {
  connect(runner?: ContractRunner | null): AlloraAdapterAdmin;
  waitForDeployment(): Promise<this>;

  interface: AlloraAdapterAdminInterface;
