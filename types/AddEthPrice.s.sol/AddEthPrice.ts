...
export interface AddEthPriceInterface extends Interface {
...
export interface AddEthPrice extends BaseContract {
  connect(runner?: ContractRunner | null): AddEthPrice;
  waitForDeployment(): Promise<this>;

  interface: AddEthPriceInterface;
